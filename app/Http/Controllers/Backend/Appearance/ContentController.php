    ...
    {   
        ...
        if (!is_null($homePageContent)) {
            ...
            if (!is_null($homePageContent->value) && $homePageContent->value != '') {
                ...
                $newContent->our_partners_title   = $request->our_partners_title ? $request->our_partners_title : '';
                $newContent->our_partners_html  = $request->our_partners_html ? $request->our_partners_html : '';

                $newContent->activities_title   = $request->activities_title ? $request->activities_title : '';
                $newContent->activities_html  = $request->activities_html ? $request->activities_html : '';

                $newContent->advisory_committee_title   = $request->advisory_committee_title ? $request->advisory_committee_title : '';
                $newContent->advisory_committee_html  = $request->advisory_committee_html ? $request->advisory_committee_html : '';
            ...
            $newContent          = new MediaManager; //temp obj
            $newContent->id      = rand(100000, 999999);
            $newContent->about_us_title   = $request->about_us_title ? $request->about_us_title : '';
            $newContent->about_us_html   = $request->about_us_html ? $request->about_us_html : '';
            $newContent->about_us_image  = $request->about_us_image ? $request->about_us_image : '';
