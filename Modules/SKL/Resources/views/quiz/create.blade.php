...
@section('title')
    {{ localize('Add Quiz') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
    ...
    <div class="container mt-3">
                ...
                <div class="card tt-page-header">
                    <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                        <div class="tt-page-title">
                            <h2 class="h5 mb-lg-0">{{ localize('Add Quiz') }}</h2>
                        </div>
        ...
        <div class="row mb-4 g-4">
            <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                <form action="{{ route('admin.quize.store') }}" method="POST" class="pb-650" id="product-form">
                    @csrf 
                    <div class="card mb-4" id="section-1">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input class="form-control" type="text" value="{{old('title')}}" id="title"  name="title" required> 
                            </div>
