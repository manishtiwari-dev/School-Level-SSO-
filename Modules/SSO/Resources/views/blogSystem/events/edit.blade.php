...
@section('title')
    {{ localize('Update Events') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
    ...
    <div class="container">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-auto flex-grow-1">
                                <div class="tt-page-title">
                                    <h2 class="h5 mb-0">{{ localize('Update Events') }} <sup
        ...
        <div class="row mb-4 g-4">
            ...
            <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                <form action="{{ route('admin.events.update') }}" method="POST" class="pb-650">
                    @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="title" id="title"
                                    placeholder="{{ localize('Type events title') }}" class="form-control" required
                            ...
                            @if (env('DEFAULT_LANGUAGE') == $lang_key)
                                <div class="mb-4">
                                    <label for="slug" class="form-label">{{ localize('Event Slug') }}</label>
                                    <input type="text" name="slug" id="slug"
                                        placeholder="{{ localize('Type event slug') }}" class="form-control" required
                                        value="{{ $blog->slug }}">
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label class="form-label">{{ localize('Events Details Image') }}
                                        (1200x700)</label>
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">{{ localize('Choose Event Details Image') }}</span>
                                        <!-- choose media -->
                                        <div class="tt-product-thumb show-selected-files mt-3">
                                            <div class="avatar avatar-xl cursor-pointer choose-media"
                                                data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom"
