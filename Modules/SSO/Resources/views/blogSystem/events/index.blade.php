                        ...
                        <div class="tt-action">
                            @can('add_blogs')
                                <a href="{{ route('admin.events.create') }}" class="btn btn-primary"><i
                                        data-feather="plus"></i> {{ localize('Add Events') }}</a>
                            @endcan
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end shadow">
                                                ...
                                                @can('edit_blogs')
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.events.edit', ['id' => $blog->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                ...
                                                @can('delete_blogs')
                                                    <a href="#" class="dropdown-item confirm-delete"
                                                        data-href="{{ route('admin.events.delete', $blog->id) }}"
...
@push('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('admin.events.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
