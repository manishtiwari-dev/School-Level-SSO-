...
class SSOEventController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sso::blogSystem.events.index', compact('blogs', 'searchKey', 'is_published'));
    }
    ...
    public function create()
    {
        ...
        $tags = Tag::all();
        return view('sso::blogSystem.events.create', compact('categories', 'tags'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('sso::blogSystem.events.edit', compact('blog', 'categories', 'tags', 'lang_key'));
    }
